...
|-----------------------------------------------|----------------------------|
| SIEM Implementation and Log Analysis          | SOC In My Pocket|
| Network Traffic Monitoring and Attack Detection | SOC In My Pocket|
| Security Automation with Shuffle SOAR         | SOC In My Pocket|
| Incident Response Planning and Execution      | SOC In My Pocket|
| Case Management with TheHive                  | SOC In My Pocket|
| Scripting and Automation for Threat Mitigation | SOC In My Pocket|
...
- SOC In My Pocket
- Trap The Hacker
- Boss of the SOC Walkthrough (Story Telling)
